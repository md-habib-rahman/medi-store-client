...
export default function MedicineDetail({
  ...
  //   console.log(medicine.seller.name);
    ...
    <div className="container mx-auto px-4 py-12 max-w-6xl font-sans">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-5">
          <div
            className="relative aspect-square rounded-2xl border-2 bg-white p-8 flex items-center justify-center shadow-sm overflow-hidden"
          ...
          <div className="mt-6 flex items-center justify-center gap-2 p-4 rounded-lg border border-dashed border-slate-200 bg-slate-50">
            ...
            <span className="text-sm font-medium text-slate-600">
              100% Genuine Medicine Guaranteed
            </span>
          </div>
        </div>
        ...
        <div className="lg:col-span-7 flex flex-col">
          <div className="mb-4">
            ...
            <div
              className="flex items-center gap-2 text-xl font-semibold italic"
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-10">
            ...
            <Badge variant="outline" className="h-14 px-8 border-2 rounded-lg flex flex-col border-[#2F91CC]"><p className="font-bold">Merchant</p><p>{medicine?.seller?.name}</p></Badge>
